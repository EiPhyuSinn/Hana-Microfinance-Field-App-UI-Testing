...
describe("Making Future Collection", () => {
    ...
    it ('Upload Collection in Day Close', async () => {
        const label1 = await $('//*[@text="REPAYMENT COLLECTION"]');
        const label2 = await $('//*[@text="Day Close"]');

        // const stillNotInHomeScreen = await label1.isDisplayed() || await label2.isDisplayed();

        // while (stillNotInHomeScreen) {
        //     await driver.back()
        // }
