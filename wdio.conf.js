	...
	capabilities: [
		{
            ...
            'appium:app': path.join(
                process.cwd(),
                './app/android/Hana-MFI-Field-App-2.6.0 - 2060001-uat (1).apk'
            ),
			...
			// nativeWebTap: true, // Ensure tap actions are treated as native
			// newCommandTimeout: 300 // Increase timeout for complex touch actions
            // "udid": "RF8T611TQHT"
			port: 4723
        },
		// {
